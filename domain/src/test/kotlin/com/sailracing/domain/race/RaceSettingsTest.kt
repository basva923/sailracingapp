...
class RaceSettingsTest {
    ...
    fun `defaults`() {
        ...
        assertEquals(RaceSettings.DEFAULT_CLOSE_HAULED_BAND, settings.closeHauledBandDegrees)
        assertEquals(20, settings.closeHauledBandDegrees)
        assertEquals(10..35, RaceSettings.CLOSE_HAULED_BAND_RANGE)
