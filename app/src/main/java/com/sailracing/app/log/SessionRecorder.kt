...
class SessionRecorder(private val stateIntervalMillis: Long = DEFAULT_STATE_INTERVAL_MILLIS) {
    ...
    fun start(nowMillis: Long, versionName: String, settings: AppSettings): LogRecord {
        ...
        return LogRecord.of(
            ...
            "correlationLengthMeters" to race.course.windField.correlationLengthMeters,
            "spatialSpreadDegrees" to race.course.windField.spatialSpreadDegrees,
    ...
    private fun state(snapshot: RaceSnapshot): LogRecord {
        ...
        return LogRecord.of(
            ...
            "measuredCells" to course?.windField?.measuredCount,
